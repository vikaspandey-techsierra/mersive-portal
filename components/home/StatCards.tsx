...
const StatCards = ({ stats }: { stats: DashboardStats }) => {
  ...
  return (
    <div className=" flex justify-around gap-6  overflow-hidden  text-[#090814] font-poppins px-8">
      {cards.map((card, i) => (
        <div
          key={i}
        ...
        >
          <div className="flex items-center gap-2.5">
            <div className="w-11 h-11 rounded-lg flex items-center justify-center text-white bg-[#5E54C5] ">
